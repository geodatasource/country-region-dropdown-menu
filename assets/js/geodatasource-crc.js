(function(root, factory) {
    ...
    var generateCountryField = function(countryElement) {
        ...
        //get region-data-language attribute
        var region_lang = countryElement.getAttribute("region-data-language");
        ...
        var geodatasource_data=[["AF","Afghanistan",af.slice(0, -(arrlen-af_region.length+1))],["AX","Aland Islands",ax.slice(0, -(arrlen-ax_region.length+1))],["AL","Albania",al.slice(0, -(arrlen-al_region.length+1))],["DZ","Algeria",dz.slice(0, -(arrlen-dz_region.length+1))],["AS","American Samoa",as.slice(0, -(arrlen-as_region.length+1))],["AD","Andorra",ad.slice(0, -(arrlen-ad_region.length+1))],["AO","Angola",ao.slice(0, -(arrlen-ao_region.length+1))],["AI","Anguilla",ai.slice(0, -(arrlen-ai_region.length+1))],["AQ","Antarctica",aq.slice(0, -(arrlen-aq_region.length+1))],["AG","Antigua And Barbuda",ag.slice(0, -(arrlen-ag_region.length+1))],["AR","Argentina",ar.slice(0, -(arrlen-ar_region.length+1))],["AM","Armenia",am.slice(0, -(arrlen-am_region.length+1))],["AW","Aruba",aw.slice(0, -(arrlen-aw_region.length+1))],["AU","Australia",au.slice(0, -(arrlen-au_region.length+1))],["AT","Austria",at.slice(0, -(arrlen-at_region.length+1))],["AZ","Azerbaijian",az.slice(0, -(arrlen-az_region.length+1))],["BS","Bahamas",bs.slice(0, -(arrlen-bs_region.length+1))],["BH","Bahrain",bh.slice(0, -(arrlen-bh_region.length+1))],["BD","Bangladesh",bd.slice(0, -(arrlen-bd_region.length+1))],["BB","Barbados",bb.slice(0, -(arrlen-bb_region.length+1))],["BY","Belarus",by.slice(0, -(arrlen-by_region.length+1))],["BE","Belgium",be.slice(0, -(arrlen-be_region.length+1))],["BZ","Belize",bz.slice(0, -(arrlen-bz_region.length+1))],["BJ","Benin",bj.slice(0, -(arrlen-bj_region.length+1))],["BM","Bermuda",bm.slice(0, -(arrlen-bm_region.length+1))],["BT","Bhutan",bt.slice(0, -(arrlen-bt_region.length+1))],["BO","Bolivia, Plurinational State Of",bo.slice(0, -(arrlen-bo_region.length+1))],["BQ","Bonaire, Sint Eustatius and Saba",bq.slice(0, -(arrlen-bq_region.length+1))],["BA","Bosnia And Herzegovina",ba.slice(0, -(arrlen-ba_region.length+1))],["BW","Botswana",bw.slice(0, -(arrlen-bw_region.length+1))],["BR","Brazil",br.slice(0, -(arrlen-br_region.length+1))],["IO","British Indian Ocean Territory",io.slice(0, -(arrlen-io_region.length+1))],["BN","Brunei Darussalam",bn.slice(0, -(arrlen-bn_region.length+1))],["BG","Bulgaria",bg.slice(0, -(arrlen-bg_region.length+1))],["BF","Burkina Faso",bf.slice(0, -(arrlen-bf_region.length+1))],["BI","Burundi",bi.slice(0, -(arrlen-bi_region.length+1))],["CV","Cabo Verde",cv.slice(0, -(arrlen-cv_region.length+1))],["KH","Cambodia",kh.slice(0, -(arrlen-kh_region.length+1))],["CM","Cameroon",cm.slice(0, -(arrlen-cm_region.length+1))],["CA","Canada",ca.slice(0, -(arrlen-ca_region.length+1))],["KY","Cayman Islands",ky.slice(0, -(arrlen-ky_region.length+1))],["CF","Central African Republic",cf.slice(0, -(arrlen-cf_region.length+1))],["TD","Chad",td.slice(0, -(arrlen-td_region.length+1))],["CL","Chile",cl.slice(0, -(arrlen-cl_region.length+1))],["CN","China",cn.slice(0, -(arrlen-cn_region.length+1))],["CX","Christmas Island",cx.slice(0, -(arrlen-cx_region.length+1))],["CC","Cocos (Keeling) Islands",cc.slice(0, -(arrlen-cc_region.length+1))],["CO","Colombia",co.slice(0, -(arrlen-co_region.length+1))],["KM","Comoros",km.slice(0, -(arrlen-km_region.length+1))],["CG","Congo",cg.slice(0, -(arrlen-cg_region.length+1))],["CD","Congo, The Democratic Republic Of The",cd.slice(0, -(arrlen-cd_region.length+1))],["CK","Cook Islands",ck.slice(0, -(arrlen-ck_region.length+1))],["CR","Costa Rica",cr.slice(0, -(arrlen-cr_region.length+1))],["CI","Cote d'Invoire",ci.slice(0, -(arrlen-ci_region.length+1))],["HR","Croatia",hr.slice(0, -(arrlen-hr_region.length+1))],["CU","Cuba",cu.slice(0, -(arrlen-cu_region.length+1))],["CW","Curacao",cw.slice(0, -(arrlen-cw_region.length+1))],["CY","Cyprus",cy.slice(0, -(arrlen-cy_region.length+1))],["CZ","Czechia",cz.slice(0, -(arrlen-cz_region.length+1))],["DK","Denmark",dk.slice(0, -(arrlen-dk_region.length+1))],["DJ","Djibouti",dj.slice(0, -(arrlen-dj_region.length+1))],["DM","Dominica",dm.slice(0, -(arrlen-dm_region.length+1))],["DO","Dominican Republic",do1.slice(0, -(arrlen-do1_region.length+1))],["EC","Ecuador",ec.slice(0, -(arrlen-ec_region.length+1))],["EG","Egypt",eg.slice(0, -(arrlen-eg_region.length+1))],["SV","El Salvador",sv.slice(0, -(arrlen-sv_region.length+1))],["GQ","Equatorial Guinea",gq.slice(0, -(arrlen-gq_region.length+1))],["ER","Eritrea",er.slice(0, -(arrlen-er_region.length+1))],["EE","Estonia",ee.slice(0, -(arrlen-ee_region.length+1))],["ET","Ethiopia",et.slice(0, -(arrlen-et_region.length+1))],["FK","Falkland Islands (Malvinas)",fk.slice(0, -(arrlen-fk_region.length+1))],["FO","Faroe Islands",fo.slice(0, -(arrlen-fo_region.length+1))],["FJ","Fiji",fj.slice(0, -(arrlen-fj_region.length+1))],["FI","Finland",fi.slice(0, -(arrlen-fi_region.length+1))],["FR","France",fr.slice(0, -(arrlen-fr_region.length+1))],["GF","French Guiana",gf.slice(0, -(arrlen-gf_region.length+1))],["PF","French Polynesia",pf.slice(0, -(arrlen-pf_region.length+1))],["TF","French Southern Territories",tf.slice(0, -(arrlen-tf_region.length+1))],["GA","Gabon",ga.slice(0, -(arrlen-ga_region.length+1))],["GM","Gambia",gm.slice(0, -(arrlen-gm_region.length+1))],["GE","Georgia",ge.slice(0, -(arrlen-ge_region.length+1))],["DE","Germany",de.slice(0, -(arrlen-de_region.length+1))],["GH","Ghana",gh.slice(0, -(arrlen-gh_region.length+1))],["GI","Gibraltar",gi.slice(0, -(arrlen-gi_region.length+1))],["GR","Greece",gr.slice(0, -(arrlen-gr_region.length+1))],["GL","Greenland",gl.slice(0, -(arrlen-gl_region.length+1))],["GD","Grenada",gd.slice(0, -(arrlen-gd_region.length+1))],["GP","Guadeloupe",gp.slice(0, -(arrlen-gp_region.length+1))],["GU","Guam",gu.slice(0, -(arrlen-gu_region.length+1))],["GT","Guatemala",gt.slice(0, -(arrlen-gt_region.length+1))],["GG","Guernsey",gg.slice(0, -(arrlen-gg_region.length+1))],["GN","Guinea",gn.slice(0, -(arrlen-gn_region.length+1))],["GW","Guinea-Bissau",gw.slice(0, -(arrlen-gw_region.length+1))],["GY","Guyana",gy.slice(0, -(arrlen-gy_region.length+1))],["HT","Haiti",ht.slice(0, -(arrlen-ht_region.length+1))],["VA","Holy See",va.slice(0, -(arrlen-va_region.length+1))],["HN","Honduras",hn.slice(0, -(arrlen-hn_region.length+1))],["HK","Hong Kong",hk.slice(0, -(arrlen-hk_region.length+1))],["HU","Hungary",hu.slice(0, -(arrlen-hu_region.length+1))],["IS","Iceland",is.slice(0, -(arrlen-is_region.length+1))],["IN","India",in1.slice(0, -(arrlen-in1_region.length+1))],["ID","Indonesia",id.slice(0, -(arrlen-id_region.length+1))],["IR","Iran, Islamic Republic Of",ir.slice(0, -(arrlen-ir_region.length+1))],["IQ","Iraq",iq.slice(0, -(arrlen-iq_region.length+1))],["IE","Ireland",ie.slice(0, -(arrlen-ie_region.length+1))],["IM","Isle Of Man",im.slice(0, -(arrlen-im_region.length+1))],["IL","Israel",il.slice(0, -(arrlen-il_region.length+1))],["IT","Italy",it.slice(0, -(arrlen-it_region.length+1))],["JM","Jamaica",jm.slice(0, -(arrlen-jm_region.length+1))],["JP","Japan",jp.slice(0, -(arrlen-jp_region.length+1))],["JE","Jersey",je.slice(0, -(arrlen-je_region.length+1))],["JO","Jordan",jo.slice(0, -(arrlen-jo_region.length+1))],["KZ","Kazakhstan",kz.slice(0, -(arrlen-kz_region.length+1))],["KE","Kenya",ke.slice(0, -(arrlen-ke_region.length+1))],["KI","Kiribati",ki.slice(0, -(arrlen-ki_region.length+1))],["KP","Korea, Democratic People's Republic Of",kp.slice(0, -(arrlen-kp_region.length+1))],["KR","Korea, Republic Of",kr.slice(0, -(arrlen-kr_region.length+1))],["KW","Kuwait",kw.slice(0, -(arrlen-kw_region.length+1))],["KG","Kyrgyzstan",kg.slice(0, -(arrlen-kg_region.length+1))],["LA","Lao People's Democratic Republic",la.slice(0, -(arrlen-la_region.length+1))],["LV","Latvia",lv.slice(0, -(arrlen-lv_region.length+1))],["LB","Lebanon",lb.slice(0, -(arrlen-lb_region.length+1))],["LS","Lesotho",ls.slice(0, -(arrlen-ls_region.length+1))],["LR","Liberia",lr.slice(0, -(arrlen-lr_region.length+1))],["LY","Libya",ly.slice(0, -(arrlen-ly_region.length+1))],["LI","Liechtenstein",li.slice(0, -(arrlen-li_region.length+1))],["LT","Lithuania",lt.slice(0, -(arrlen-lt_region.length+1))],["LU","Luxembourg",lu.slice(0, -(arrlen-lu_region.length+1))],["MO","Macao",mo.slice(0, -(arrlen-mo_region.length+1))],["MK","Macedonia, The Former Yugoslav Republic Of",mk.slice(0, -(arrlen-mk_region.length+1))],["MG","Madagascar",mg.slice(0, -(arrlen-mg_region.length+1))],["MW","Malawi",mw.slice(0, -(arrlen-mw_region.length+1))],["MY","Malaysia",my.slice(0, -(arrlen-my_region.length+1))],["MV","Maldives",mv.slice(0, -(arrlen-mv_region.length+1))],["ML","Mali",ml.slice(0, -(arrlen-ml_region.length+1))],["MT","Malta",mt.slice(0, -(arrlen-mt_region.length+1))],["MH","Marshall Islands",mh.slice(0, -(arrlen-mh_region.length+1))],["MQ","Martinique",mq.slice(0, -(arrlen-mq_region.length+1))],["MR","Mauritania",mr.slice(0, -(arrlen-mr_region.length+1))],["MU","Mauritius",mu.slice(0, -(arrlen-mu_region.length+1))],["YT","Mayotte",yt.slice(0, -(arrlen-yt_region.length+1))],["MX","Mexico",mx.slice(0, -(arrlen-mx_region.length+1))],["FM","Micronesia, Federated States Of",fm.slice(0, -(arrlen-fm_region.length+1))],["MD","Moldova, Republic Of",md.slice(0, -(arrlen-md_region.length+1))],["MC","Monaco",mc.slice(0, -(arrlen-mc_region.length+1))],["MN","Mongolia",mn.slice(0, -(arrlen-mn_region.length+1))],["ME","Montenegro",me.slice(0, -(arrlen-me_region.length+1))],["MS","Montserrat",ms.slice(0, -(arrlen-ms_region.length+1))],["MA","Morocco",ma.slice(0, -(arrlen-ma_region.length+1))],["MZ","Mozambique",mz.slice(0, -(arrlen-mz_region.length+1))],["MM","Myanmar",mm.slice(0, -(arrlen-mm_region.length+1))],["NA","Namibia",na.slice(0, -(arrlen-na_region.length+1))],["NR","Nauru",nr.slice(0, -(arrlen-nr_region.length+1))],["NP","Nepal",np.slice(0, -(arrlen-np_region.length+1))],["NL","Netherlands",nl.slice(0, -(arrlen-nl_region.length+1))],["NC","New Caledonia",nc.slice(0, -(arrlen-nc_region.length+1))],["NZ","New Zealand",nz.slice(0, -(arrlen-nz_region.length+1))],["NI","Nicaragua",ni.slice(0, -(arrlen-ni_region.length+1))],["NE","Niger",ne.slice(0, -(arrlen-ne_region.length+1))],["NG","Nigeria",ng.slice(0, -(arrlen-ng_region.length+1))],["NU","Niue",nu.slice(0, -(arrlen-nu_region.length+1))],["NF","Norfolk Island",nf.slice(0, -(arrlen-nf_region.length+1))],["MP","Northern Mariana Islands",mp.slice(0, -(arrlen-mp_region.length+1))],["NO","Norway",no.slice(0, -(arrlen-no_region.length+1))],["OM","Oman",om.slice(0, -(arrlen-om_region.length+1))],["PK","Pakistan",pk.slice(0, -(arrlen-pk_region.length+1))],["PW","Palau",pw.slice(0, -(arrlen-pw_region.length+1))],["PS","Palestine, State Of",ps.slice(0, -(arrlen-ps_region.length+1))],["PA","Panama",pa.slice(0, -(arrlen-pa_region.length+1))],["PG","Papua New Guinea",pg.slice(0, -(arrlen-pg_region.length+1))],["PY","Paraguay",py.slice(0, -(arrlen-py_region.length+1))],["PE","Peru",pe.slice(0, -(arrlen-pe_region.length+1))],["PH","Philippines",ph.slice(0, -(arrlen-ph_region.length+1))],["PN","Pitcairn",pn.slice(0, -(arrlen-pn_region.length+1))],["PL","Poland",pl.slice(0, -(arrlen-pl_region.length+1))],["PT","Portugal",pt.slice(0, -(arrlen-pt_region.length+1))],["PR","Puerto Rico",pr.slice(0, -(arrlen-pr_region.length+1))],["QA","Qatar",qa.slice(0, -(arrlen-qa_region.length+1))],["RE","Reunion",re.slice(0, -(arrlen-re_region.length+1))],["RO","Romania",ro.slice(0, -(arrlen-ro_region.length+1))],["RU","Russian Federation",ru.slice(0, -(arrlen-ru_region.length+1))],["RW","Rwanda",rw.slice(0, -(arrlen-rw_region.length+1))],["BL","Saint Barthelemy",bl.slice(0, -(arrlen-bl_region.length+1))],["SH","Saint Helena, Ascension And Tristan Da Cunha",sh.slice(0, -(arrlen-sh_region.length+1))],["KN","Saint Kitts And Nevis",kn.slice(0, -(arrlen-kn_region.length+1))],["LC","Saint Lucia",lc.slice(0, -(arrlen-lc_region.length+1))],["MF","Saint Martin (French Part)",mf.slice(0, -(arrlen-mf_region.length+1))],["PM","Saint Pierre and Miquelon",pm.slice(0, -(arrlen-pm_region.length+1))],["VC","Saint Vincent And The Grenadines",vc.slice(0, -(arrlen-vc_region.length+1))],["WS","Samoa",ws.slice(0, -(arrlen-ws_region.length+1))],["SM","San Marino",sm.slice(0, -(arrlen-sm_region.length+1))],["ST","Sao Tome And Principe",st.slice(0, -(arrlen-st_region.length+1))],["SA","Saudi Arabia",sa.slice(0, -(arrlen-sa_region.length+1))],["SN","Senegal",sn.slice(0, -(arrlen-sn_region.length+1))],["RS","Serbia",rs.slice(0, -(arrlen-rs_region.length+1))],["SC","Seychelles",sc.slice(0, -(arrlen-sc_region.length+1))],["SL","Sierra Leone",sl.slice(0, -(arrlen-sl_region.length+1))],["SG","Singapore",sg.slice(0, -(arrlen-sg_region.length+1))],["SX","Sint Maarten (Dutch Part)",sx.slice(0, -(arrlen-sx_region.length+1))],["SK","Slovakia",sk.slice(0, -(arrlen-sk_region.length+1))],["SI","Slovenia",si.slice(0, -(arrlen-si_region.length+1))],["SB","Solomon Islands",sb.slice(0, -(arrlen-sb_region.length+1))],["SO","Somalia",so.slice(0, -(arrlen-so_region.length+1))],["ZA","South Africa",za.slice(0, -(arrlen-za_region.length+1))],["GS","South Georgia and the South Sandwich Islands",gs.slice(0, -(arrlen-gs_region.length+1))],["SS","South Sudan",ss.slice(0, -(arrlen-ss_region.length+1))],["ES","Spain",es.slice(0, -(arrlen-es_region.length+1))],["LK","Sri Lanka",lk.slice(0, -(arrlen-lk_region.length+1))],["SD","Sudan",sd.slice(0, -(arrlen-sd_region.length+1))],["SR","Suriname",sr.slice(0, -(arrlen-sr_region.length+1))],["SJ","Svalbard And Jan Mayen",sj.slice(0, -(arrlen-sj_region.length+1))],["SZ","Swaziland",sz.slice(0, -(arrlen-sz_region.length+1))],["SE","Sweden",se.slice(0, -(arrlen-se_region.length+1))],["CH","Switzerland",ch.slice(0, -(arrlen-ch_region.length+1))],["SY","Syrian Arab Republic",sy.slice(0, -(arrlen-sy_region.length+1))],["TW","Taiwan",tw.slice(0, -(arrlen-tw_region.length+1))],["TJ","Tajikistan",tj.slice(0, -(arrlen-tj_region.length+1))],["TZ","Tanzania, United Republic Of",tz.slice(0, -(arrlen-tz_region.length+1))],["TH","Thailand",th.slice(0, -(arrlen-th_region.length+1))],["TL","Timor-Leste",tl.slice(0, -(arrlen-tl_region.length+1))],["TG","Togo",tg.slice(0, -(arrlen-tg_region.length+1))],["TK","Tokelau",tk.slice(0, -(arrlen-tk_region.length+1))],["TO","Tonga",to.slice(0, -(arrlen-to_region.length+1))],["TT","Trinidad And Tobago",tt.slice(0, -(arrlen-tt_region.length+1))],["TN","Tunisia",tn.slice(0, -(arrlen-tn_region.length+1))],["TR","Turkey",tr.slice(0, -(arrlen-tr_region.length+1))],["TM","Turkmenistan",tm.slice(0, -(arrlen-tm_region.length+1))],["TC","Turks and Caicos Islands",tc.slice(0, -(arrlen-tc_region.length+1))],["TV","Tuvalu",tv.slice(0, -(arrlen-tv_region.length+1))],["UG","Uganda",ug.slice(0, -(arrlen-ug_region.length+1))],["UA","Ukraine",ua.slice(0, -(arrlen-ua_region.length+1))],["AE","United Arab Emirates",ae.slice(0, -(arrlen-ae_region.length+1))],["GB","United Kingdom",gb.slice(0, -(arrlen-gb_region.length+1))],["US","United States",us.slice(0, -(arrlen-us_region.length+1))],["UM","United States Minor Outlying Islands",um.slice(0, -(arrlen-um_region.length+1))],["UY","Uruguay",uy.slice(0, -(arrlen-uy_region.length+1))],["UZ","Uzbekistan",uz.slice(0, -(arrlen-uz_region.length+1))],["VU","Vanuatu",vu.slice(0, -(arrlen-vu_region.length+1))],["VE","Venezuela, Bolivarian Republic Of",ve.slice(0, -(arrlen-ve_region.length+1))],["VN","Viet Nam",vn.slice(0, -(arrlen-vn_region.length+1))],["VG","Virgin Islands, British",vg.slice(0, -(arrlen-vg_region.length+1))],["VI","Virgin Islands, U.S.",vi.slice(0, -(arrlen-vi_region.length+1))],["WF","Wallis and Futuna",wf.slice(0, -(arrlen-wf_region.length+1))],["EH","Western Sahara",eh.slice(0, -(arrlen-eh_region.length+1))],["YE","Yemen",ye.slice(0, -(arrlen-ye_region.length+1))],["ZM","Zambia",zm.slice(0, -(arrlen-zm_region.length+1))],["ZW","Zimbabwe",zw.slice(0, -(arrlen-zw_region.length+1))]];
